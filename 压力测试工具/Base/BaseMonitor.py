...
def get_men(pkg_name, devices):
    try:
        ...
        str_men = ".".join([x.decode() for x in output])  # 转换为string
        print(str_men)
        men2 = int(re.findall("TOTAL.(\d+)*", str_men, re.S)[0])
    except:
        men2 = 0
...
if __name__ == '__main__':
    # get_men("com.gitvjimi.video", "192.168.36.108")
    get_fps("com.xgimi.home", "192.168.0.181")
    # get_battery("192.168.36.108")
    # print(get_pid("com.gitvjimi.video", "192.168.36.108"))
    # totalCpuTime("192.168.36.108")
    # print(get_cpu_kel("192.168.36.108"))
    # pid = get_pid("com.gitvjimi.video", "192.168.36.108")
    # cpukel = get_cpu_kel("192.168.36.108")
    # cpu_rate(pid, cpukel, "192.168.36.108")
